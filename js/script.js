/**
 * Solaris Energia - Script Principal
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                alert('Obrigado pelo interesse! Nossos engenheiros realizarão um estudo de viabilidade técnica e enviarão sua proposta personalizada em até 24 horas.');
                form.reset();
    ...
    // 5. Reveal on Scroll for Solar Cards
    const solarCards = document.querySelectorAll('.solar-card');
    const revealCards = () => {
